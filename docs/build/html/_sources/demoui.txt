...
The demo site can be downloaded as a standalone image from [https://hub.docker.com/r/vaporio/opendcre-demo/ DockerHub], or the demo source can be download from [https://github.com/vapor-ware/opendcre-demo GitHub].
