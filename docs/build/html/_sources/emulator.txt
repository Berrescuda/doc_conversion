...
To modify the emulator output, users may clone the [https://github.com/vapor-ware/OpenDCRE OpenDCRE GitHub repository], and change the contents of `simple.json`, then rebuild the OpenDCRE container.
...
{| class="wikitable"
! style="text-align:center;" | Device Type		
!Action Supported
|-
|`thermistor`
|`read`
...
|-
|`pressure`
|none (may be added in future OpenDCRE release)
|-
|`led`	
|none (may be added in future OpenDCRE release)
|-
